...
class PhoneUI {
    constructor() {
        ...
        this.state = {
            ...
            callTokenStatus: 'none',  // none | minting | pending | confirmed | calling
        }
    ...
    updateCallButtonStatus(status) {
        this.state.callTokenStatus = status
        ...
        const statusLabels = {
            ...
            'confirmed': '☎️ Ready to Start a Call',
            'calling': '📞 Call Ringing'
        }
